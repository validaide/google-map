...
class ApiRendererTest extends TestCase
{
    ...
    {
        $this->assertSame(
            'function ivory_google_map_init_source(src){var script=document.createElement("script");script.type="text/javascript";script.crossorigin="anonymous";script.defer=true;script.src=src;document.getElementsByTagName("head")[0].appendChild(script);};function ivory_google_map_init_requirement(c,r){if(r()){c();}else{var i=setInterval(function(){if(r()){clearInterval(i);c();}},100);}};function ivory_google_map_init(){ivory_google_map_init_source("source1");ivory_google_map_init_source("source2");ivory_google_map_init_requirement(main_callback,function(){return requirement1&&requirement2;});};ivory_google_map_init_source("https://maps.googleapis.com/maps/api/js?language=en&libraries=library1%2Clibrary2&callback=ivory_google_map_init&loading=async");',
...
ivory_google_map_init_source("https://maps.googleapis.com/maps/api/js?language=en&libraries=library1%2Clibrary2&callback=ivory_google_map_init&loading=async");
EOF;
